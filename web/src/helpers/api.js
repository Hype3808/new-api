...
export async function onDiscordOAuthClicked(client_id, guildVerifyEnabled = false) {
  ...
  // When guild verification is enabled, request additional scopes for guild and role verification
  // Requirements 5.1: Request guilds and guilds.members.read OAuth scopes
  const scope = guildVerifyEnabled
