...
type CheckinSetting struct {
	...
	QuotaThreshold          int  `json:"quota_threshold"`           // 签到额度阈值
	QuotaThresholdInclusive bool `json:"quota_threshold_inclusive"` // 是否包含等于阈值
}
...
var defaultCheckinSetting = CheckinSetting{
	...
	QuotaThresholdInclusive: false,   // 默认不包含等于
}
